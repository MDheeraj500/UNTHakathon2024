...
const Signup = () => {
    ...
    return (
        <div className="h-screen w-full flex items-center justify-center relative font-inter bg-signup-background bg-cover bg-center">
            ...
            <div className="relative z-10 rounded-xl shadow-[0_0_20px_10px_rgba(0,0,0,0.8)] shadow-black w-50% bg-dark-gray
                ...
                <div className="p-8">
                    {popup ? (
                        <div className="text-center">
                            <h2 className="text-6xl font-bold mb-4   griffy-regular">Signup Completed!</h2>
                            <button
                        ...
                        <div>
                            <h2 className="w-full text-7xl font-bold text-center   mb-6 griffy-regular">Sign up</h2>
                            <div className="flex flex-col gap-4 w-full z-20">
                                <div className="flex space-x-4 ">
                                    <div className="flex-1 flex flex-col">
                                        ...
                                        <input
                                            className="w-full px-3 py-2 mt-2 text-gray-200  border border-zinc-800 bg-dark-gray bg-opacity-70 rounded focus:outline-none focus:ring-2 focus:ring-neon-orange"
                                            type="text"
                                            value={fullname}
                                    ...
                                    <div className="flex-1 flex flex-col">
                                        <label className="text-ghost-white text-lg font-medium">Email</label>
                                        <input
                                            className="w-full px-3 py-2 mt-2 text-gray-200 bg-dark-gray border border-zinc-800 bg-opacity-70 rounded focus:outline-none focus:ring-2 focus:ring-neon-orange"
                                            type="email"
                                            value={email}
                                ...
                                <div className="flex space-x-4">
                                    {/* Password Section */}
                                    <div className="flex-1 flex flex-col">
                                        <label className="text-ghost-white text-lg font-medium">Password</label>
                                        <input
                                            className="w-full px-3 py-2 mt-2 text-gray-200 bg-dark-gray bg-opacity-70 border border-zinc-800 rounded focus:outline-none focus:ring-2 focus:ring-neon-orange"
                                            type="password"
                                            value={password}
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="flex items-center justify-between mb-2">
                                        <label className="flex items-center text-ghost-white">
                                            <input
                                                type="checkbox"
                                                className="form-checkbox h-5 w-5 text-neon-green bg-dark-gray rounded focus:ring-neon-green focus:outline-none mr-2 accent-orange-500"
                                                checked={trsChecked}
                                        ...
                                        <input
                                            ...
                                            className="w-64 px-3 py-2 text-gray-200 bg-dark-gray bg-opacity-70 border border-zinc-800 rounded focus:outline-none focus:ring-2 focus:ring-neon-orange"
                                            value={trsAmount}
